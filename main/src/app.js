...
typeorm_1.createConnection().then(function (db) {
    ...
    amqp.connect("amqps://pliimsuy:Ju86YizIOQuiGD5p57SEamKU30s1OvEX@cattle.rmq2.cloudamqp.com/pliimsuy", function (error0, connection) {
        if (error0) {
            throw error0;
        }
        connection.createChannel(function (error1, channel) {
            ...
            channel.consume("product_created", function (msg) { return __awaiter(void 0, void 0, void 0, function () {
                var eventProduct, id, product, addProduct;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            eventProduct = JSON.parse(msg.content.toString());
                            id = eventProduct.id, product = __rest(eventProduct, ["id"]);
                            addProduct = __assign(__assign({}, product), { admin_id: parseInt(eventProduct.id) });
                            return [4 /*yield*/, productRepository.save(addProduct)];
                        case 1:
                            _a.sent();
